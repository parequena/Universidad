...
public class AnalizadorLexico
{
	...
	private int delta(int estado, char c)
	{
		...
		case 19:
			if(c == Token.EndOfFile) LexicalError(Token.EndOfFile); // Fin de fichero inesperado.
	...
	public Token siguienteToken()
	{
		...
		if(buffer.charAt(0) == Token.EndOfFile) return new Token(oriRow, oriCol, buffer, Token.EOF); // Creating the EOF token.
